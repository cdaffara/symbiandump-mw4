...
*
* Description: 
*      Logging macros for Scheme Recognizer.   
*      
*
*/


#ifndef SCHEME_APP_LOGGER_H

// INCLUDES

#include <e32std.h>
#include <e32def.h>
#ifdef __SCHEMEAPP_LOG__
#include <flogger.h>

/// Scheme logging directory.
_LIT( KSchemeLogDir,                   "Scheme" );
/// Scheme log file name.
_LIT( KSchemeLogFile,                  "SchemeApp.txt" );
...
#else /* not defined __TEST_SCHEME_APP_DEBUG */
...
#endif /* def __SCHEMEAPP_LOG__ */

#endif /* def SCHEME_APP_LOGGER_H */
