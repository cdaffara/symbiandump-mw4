...
namespace KJS {
    ...
    public:
        ...
        IMPORT static bool equal(const UString::Rep *, const char *);
    ...
    private:
        ...
        IMPORT static PassRefPtr<UString::Rep> add(const char *);
        IMPORT static PassRefPtr<UString::Rep> add(const UChar *, int length);
        IMPORT static PassRefPtr<UString::Rep> add(UString::Rep *);
    };
