...
namespace KJS {
  ...
  public:
    ...
    IMPORT virtual void mark();
    IMPORT virtual JSType type() const;
     ...
     * instead.
     */
    IMPORT virtual UString className() const;
     ...
     */
    IMPORT JSValue *get(ExecState *exec, const Identifier &propertyName) const;
    IMPORT JSValue *get(ExecState *exec, unsigned propertyName) const;
    ...
    IMPORT virtual bool getOwnPropertySlot(ExecState *, unsigned index, PropertySlot&);
     ...
     */
    IMPORT virtual void put(ExecState* exec, const Identifier &propertyName, JSValue* value, int attr = None);
    IMPORT virtual void put(ExecState* exec, unsigned propertyName, JSValue* value, int attr = None);
     ...
     * Objects)
     */
    IMPORT virtual bool canPut(ExecState *exec, const Identifier &propertyName) const;
     ...
     */
    IMPORT bool hasProperty(ExecState *exec, const Identifier &propertyName) const;
     ...
     * allowed.
     */
    IMPORT virtual bool deleteProperty(ExecState *exec, const Identifier &propertyName);
    IMPORT virtual bool deleteProperty(ExecState *exec, unsigned propertyName);
     ...
     * all Objects)
     */
    IMPORT virtual JSValue *defaultValue(ExecState *exec, JSType hint) const;
     ...
     * false
     */
    IMPORT virtual bool implementsConstruct() const;
     ...
     */
    IMPORT virtual JSObject* construct(ExecState* exec, const List& args);
    IMPORT virtual JSObject* construct(ExecState* exec, const List& args, const Identifier& functionName, const UString& sourceURL, int lineNumber);
     ...
     */
    IMPORT JSValue *call(ExecState *exec, JSObject *thisObj, const List &args);
    IMPORT virtual JSValue *callAsFunction(ExecState *exec, JSObject *thisObj, const List &args);
     ...
     * false
     */
    IMPORT virtual bool hasInstance(ExecState *exec, JSValue *value);

    IMPORT virtual void getPropertyNames(ExecState*, PropertyNameArray&);

    virtual JSValue *toPrimitive(ExecState *exec, JSType preferredType = UnspecifiedType) const;
    IMPORT virtual bool toBoolean(ExecState *exec) const;
    IMPORT virtual double toNumber(ExecState *exec) const;
    IMPORT virtual UString toString(ExecState *exec) const;
    IMPORT virtual JSObject *toObject(ExecState *exec) const;
    ...
    IMPORT void putDirect(const Identifier &propertyName, JSValue *value, int attr = 0);
    IMPORT void putDirect(const Identifier &propertyName, int value, int attr = 0);
    IMPORT void removeDirect(const Identifier &propertyName);
    ...
    IMPORT void fillGetterPropertySlot(PropertySlot& slot, JSValue **location);
...
IMPORT JSObject *throwError(ExecState *, ErrorType, const UString &message);
IMPORT JSObject *throwError(ExecState *, ErrorType, const char *message);
IMPORT JSObject *throwError(ExecState *, ErrorType);
...
inline bool JSObject::checkStackDepthTooDeep()
{
#if PLATFORM(SYMBIAN)
  unsigned int approxSPvar;  // keep this as first item in func so it's allocated at approx SP location
  void * sp = &approxSPvar;
  if((unsigned int)sp < Collector::CallStackGrowthThresh)
  {
    Collector::recursivelyOrphanedMarkTops.append(this);
	return true;
  }
  else
  {
