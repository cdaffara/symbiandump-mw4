...
*/
    ...
    public:
        ...
        IMPORT JSValue *get(const Identifier &name) const;
        JSValue *get(const Identifier &name, unsigned &attributes) const;
        IMPORT JSValue **getLocation(const Identifier &name);

        void mark() const;
        void getEnumerablePropertyNames(PropertyNameArray&) const;
        void getSparseArrayPropertyNames(PropertyNameArray&) const;

        IMPORT void save(SavedProperties &) const;
        IMPORT void restore(const SavedProperties &p);
