...
namespace KJS {
  ...
  public:
    ...
    IMPORT StringInstance(JSObject *proto, StringImp* string);
    IMPORT StringInstance(JSObject *proto, const UString &string);

    IMPORT virtual bool getOwnPropertySlot(ExecState*, const Identifier&, PropertySlot&);
