...
#else
        // armcc compiler
        typedef HashMapTranslator< !KeyTraits::needsDestruction || KeyStorageTraits::needsDestruction, ValueType, ValueTraits, ValueStorageTraits, HashFunctions> TranslatorType;
#endif
