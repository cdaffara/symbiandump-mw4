...
# -- Attributes --
  ...
  console				Window::Console_			DontDelete
# -- Event Listeners --
...
ConsoleObject *Window::console(ExecState *exec) const
{
  return new ConsoleObject(exec, impl()->frame()->page()->chrome());
}
