...
#if PLATFORM(SYMBIAN)
    ,CSS_PROP__WAP_MARQUEE_DIR,
    CSS_PROP__WAP_MARQUEE_LOOP,
    CSS_PROP__WAP_MARQUEE_SPEED,
    CSS_PROP__WAP_MARQUEE_STYLE
#endif
};
...
#if PLATFORM(SYMBIAN)
                case WAP_MARQUEE:
                    return new CSSPrimitiveValue(CSS_VAL__WAP_MARQUEE);
#endif
                case NONE:
                    return new CSSPrimitiveValue(CSS_VAL_NONE);
            }
