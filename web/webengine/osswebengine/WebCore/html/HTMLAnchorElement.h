...
#if PLATFORM(SYMBIAN)    
    virtual void setHovered(bool over = true);        
...
#if PLATFORM(SYMBIAN)    
    String cti() const;
    void setCti(const String&);

    String email() const;
    void setEmail(const String&);

    String telbook() const;
    void setTelbook(const String&);
    
    bool checkTelWtaiNumber(const String& number, bool aCti);    
#endif
