...
#if PLATFORM(SYMBIAN)
    void setExecutingDocumentWrite(bool execDocWrite) { executingDocumentWrite = execDocWrite; }
    bool isExecutingDocumentWrite() { return executingDocumentWrite; }
    bool isExecutingExternalScript() { return executingExternalScript; }
#endif
...
#if PLATFORM(SYMBIAN)
    //Are we executing a document write?
    bool executingDocumentWrite;
    //Are we executing an external script?
    bool executingExternalScript;
#endif    
