...
//#include "Libxml2_xmlversion.h" // enable this when dependency on tree.h is removed 
...
XMLPUBFUN xmlCharEncoding XMLCALL
	xmlDetectCharEncoding		(const unsigned char *in,
					 int len);
// TODO: separate xmlBuffer definitions into standalone header file (and remove dependency on tree.h)
