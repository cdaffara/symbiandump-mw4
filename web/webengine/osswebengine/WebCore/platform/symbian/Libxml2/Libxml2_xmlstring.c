 ...
 * Returns a new xmlChar * or NULL
 *
 * OOM: possible --> returns NULL for cup!=NULL and sets OOM flag
 */
xmlChar *
 ...
 *
 * OOM: possible --> OOM flag is set  // TODO: support NULL result in OOM
 */
xmlChar*
xmlStrncat(xmlChar* cur, const xmlChar* add, int len)
{
    ...
    size = xmlStrlen(cur);
    // DONE: Fix xmlRealloc: Nothing to fix! Cur should not be freed...
...
xmlStrncatNew(const xmlChar *str1, const xmlChar *str2, int len) {
    ...
    if (ret == NULL) {
        ...
        //return(xmlStrndup(str1, size)); // TODO: Return NULL, because it is OOM?
        return NULL;
    }
 ...
 *
 * OOM: possible --> OOM flag is set // TODO: Support NULL result
 */
xmlChar *
...
xmlUTF8Strndup(const xmlChar *utf, int len) {
    ...
    if (ret == NULL) {
/*      // TODO: Set OOM flag and report (logging)
